...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 22 dec 2020 om 14:24
...
INSERT INTO `settings` (`id`, `hasStarted`, `created_at`, `updated_at`, `pointSystem`) VALUES
(1, 0, NULL, NULL, '10,8,6,5,4,3,2,1,0,0,0,0,0,0');
